...
namespace Business.Constants
{
    class Messages
    {
        ...
        public static string CarNameInvalid = "Araç ismi kısa";
        ...
        public static string ColorNameInvalid = "Renk Eklenemedi.";
        ...
        public static string BrandNameInvalid = "Marka İsmi Kısa.";
